...
async function run() {
  ...
  const twinSunsAdminEmail = process.env.TENANT_TWIN_SUNS_USERNAME || 'admin@twin-suns.blockvibe.org'
  ...
  const [
    ...
    readLocalFile(path.resolve(process.cwd(), 'src/scripts/twin-suns-logo.jpg'), 'twin-suns-logo-header'),
    // Footer logo
    readLocalFile(path.resolve(process.cwd(), 'src/scripts/twin-suns-logo.jpg'), 'twin-suns-logo-footer'),
    // Desert dunes at sunset
    fetchFile('https://images.unsplash.com/photo-1547234935-80c7145ec969?w=1200&q=80', 'twin-suns-hero'),
    // Sci-fi moisture vaporator look
    fetchFile('https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=800&q=80', 'twin-suns-vaporator'),
    // Board members / crew
    fetchFile('https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1200&q=80', 'twin-suns-board'),
    // Galaxy nebula for posts
    fetchFile('https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1200&q=80', 'twin-suns-post'),
  ])
  ...
  const homeDoc = await payload.create({
    ...
    data: {
          ...
          columns: [
            ...
            },
            {
              ...
              richText: lexicalRichText([
                ...
                richParagraph('Nestled within the deep, copper-toned canyons of a remote desert world at the edge of the Outer Rim, Twin Suns Oasis began as a modest settlement clustered around three ancient moisture vaporators.'),
                richParagraph('Today, it is a vibrant commune of moisture farmers, scrap-salvagers, and retired orbital pilots who have chosen a peaceful life under our twin stars, away from the heavy-handed control of the Sovereign Core.'),
                richParagraph('The Association is dedicated to maintaining our shared atmospheric collection grid, resolving scrap-salvage boundaries, and keeping Beggar’s Canyon safe for all inhabitants.'),
              ]),
            },
          ],
        },
          ...
          columns: [
            {
              ...
              richText: lexicalRichText([
                ...
                richParagraph('We collectively own and service 12 heavy-duty condenser towers. Regular filter purges keep our community water tanks at 99.8% purity.'),
              ]),
            },
            {
              type: 'text',
              ...
              richText: lexicalRichText([
                ...
                richParagraph('Hover-skiffs and T-16 sport flyers must maintain sub-sonic speeds (under 40 knots) while flying through residential canyon zones.'),
              ]),
            },
            {
              type: 'text',
              ...
              richText: lexicalRichText([
                ...
                richParagraph('Join us at the Oasis Lounge every solar-Tuesday for synth-harmonica sessions. Half-priced blue milk and roasted spice bread for residents.'),
              ]),
            },
          ],
        },
      ...
      meta: {
        ...
        description: 'Moisture, Community, and Harmony in the Outer Rim. Welcome to our dome commune.',
      },
    },
  })
  ...
  const aboutDoc = await payload.create({
    ...
    data: {
          ...
          columns: [
            {
              ...
              richText: lexicalRichText([
                ...
                richParagraph('Twin Suns Oasis was founded in the year 842 following the Great Orbital Shift. A band of star-travelers seeking independence landed in the Canyon of Whispers and established a small moisture collective. Our survival depends on collaboration, resource conservation, and self-reliance.'),
                richParagraph('Our mission is to maintain the critical machinery of our community, protect our residents from desert nomads, and cultivate a peaceful, welcoming outpost for all free species of the galaxy.'),
      ...
      meta: {
        title: 'About - Twin Suns Oasis',
        description: 'Learn about the history, council members, and mission of the Twin Suns Oasis settlement.',
      },
    },
  })
  ...
  const calendarDoc = await payload.create({
    ...
    data: {
          ...
          columns: [
            {
              ...
              richText: lexicalRichText([
                ...
                richParagraph('Check our frequency channel or the cantina board for event coordinate details.'),
                richHeading('Dune-Nomad Trade Bazaar: Solar-Sunday, 14:00', 'h3'),
                richParagraph('Exchange scrap metal and mechanical parts with local canyon clans. Peacekeepers will be on-site to ensure neutral trading.'),
                richHeading('Beggar’s Canyon Speed Trials: Solar-Friday, 18:00', 'h3'),
                richParagraph('Watch our finest local pilots navigate their customized hover-skiffs through the needle-eye rocks. Safety shielding required.'),
                richHeading('Grid Purge Maintenance: Solar-Thursday, 02:00 - 04:00', 'h3'),
                richParagraph('Water pressure will drop slightly during this time as the moisture vaporators cycle their central filters.'),
              ]),
            },
          ],
        },
      ...
      meta: {
        ...
        description: 'Check the scheduling for trade bazaars, skiff races, and maintenance windows.',
      },
    },
  })
  ...
  const membershipDoc = await payload.create({
    ...
    data: {
          ...
          columns: [
            {
              ...
              richText: lexicalRichText([
                ...
                richParagraph('Maintaining high-performance vaporator grids requires regular power cells and copper coils. Residents support our community through voluntary water credit contributions:'),
                richParagraph('• Single Dome Dweller: 10 Credits / solar-month (includes basic vaporator allotment)'),
                richParagraph('• Household Dome Unit: 20 Credits / solar-month (includes full family dome allotment)'),
                richHeading('Outpost Merchandise', 'h3'),
                richParagraph('All credits and purchases directly fund the canyon protective grid and community lounge facilities. Send your order via frequency to the President\'s office:'),
                richParagraph('• Oasis Flight Jackets: 25 Credits (sizes S, M, L, XL)'),
                richParagraph('• Twin Suns Cyber Mug: 15 Credits (insulated, heat-resistant, great for warm blue milk)'),
      ...
      meta: {
        ...
        description: 'Manage your moisture vaporator allocations and support the canyon defensive grid.',
      },
    },
  })
          ...
          columns: [
            {
              ...
              richText: lexicalRichText([
                ...
                richParagraph('Report sandstorm damage, request a vaporator diagnostic, or alert peacekeepers of safety concerns in the canyons.'),
              ]),
            },
          ],
        },
  ...
  await payload.create({
    ...
    data: {
      ...
      content: lexicalRichText([
        ...
        richParagraph('The Council is pleased to announce a formal commerce agreement with the leaders of the canyon nomadic clans.'),
        richParagraph('Under the new treaty, the clans will have designated trading booths at our bi-weekly Trade Bazaar. In return, they have agreed to bypass our residential dome perimeters and respect our moisture vaporator buffer zones.'),
        richParagraph('This ensures a safer environment for our homesteads and marks a new era of peaceful trade in our sector.'),
      ]),
      meta: {
        title: 'Dune-Nomad Peace Treaty Signed',
        description: 'Read about the new trade and security agreement with the desert nomadic clans.',
