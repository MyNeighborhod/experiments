...
async function run() {
  ...
  const [
    ...
    fetchFile('https://www.northofgranddsm.org/uploads/1/4/1/5/141517828/published/northofgrand-badge-color-blue.png?1723053124'),
    fetchFile('https://www.northofgranddsm.org/uploads/1/4/1/5/141517828/northofgrand-wordmark-color_orig.jpg'),
    fetchFile('https://www.northofgranddsm.org/uploads/1/4/1/5/141517828/editor/10690313-728536740515884-9046556421403047408-n.jpg?1723053527'),
    ...
    fetchFile('https://www.northofgranddsm.org/uploads/1/4/1/5/141517828/northofgrand-badge-color-white-1-1_orig.png'),
          ...
          columns: [
            ...
            },
            {
              ...
              richText: lexicalRichText([
                ...
                richParagraph('Our Mission is to strengthen relationships and improve quality of life for all residents and businesses in the North of Grand neighborhood. We commit to enhancing livability and revitalizing our historic neighborhood through opportunities of civic engagement. We advocate on behalf of North of Grand’s diverse residents as a liaison with local governments to preserve and uphold our community’s vibrant characteristics.'),
              ]),
            },
          ],
        },
          ...
          columns: [
            {
              ...
              richText: lexicalRichText([
                ...
                richParagraph('We have a vision for how our neighborhood can improve over the coming years and want to hear from you!'),
                richParagraph('4. Announcement of updated NoG Association structure'),
                richParagraph('5. Community Notes and Event Announcements'),
                richParagraph('We will also have a live feed of the meeting through the Facebook event.'),
              ]),
            },
          ],
        },
  ...
  const aboutDoc = await payload.create({
    ...
    data: {
      ...
      meta: {
        title: 'About - North Of Grand',
        description: 'Meet the board members and learn about the mission of North of Grand Des Moines.',
      },
    },
  })
          ...
          columns: [
            {
              ...
              richText: lexicalRichText([
                ...
                richParagraph('Donations & merchandise purchases help us put on community events such as our Annual Garage Sale and National Night Out. We are really hoping to grow our community engagement opportunities in the future and your participation directly impacts our community.'),
                richHeading('How to Order:', 'h3'),
                richParagraph('Please send an email to northofgrandpresident@gmail.com and request which size and item you\'d like to purchase. You can either pay in cash upon pickup or we can send you a Paypal invoice through your email address.'),
